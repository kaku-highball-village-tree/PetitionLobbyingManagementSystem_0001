...
PROMPT_IMAGE_TO_TEXT = (
    "この画像に見えている文字を抽出してください。\n"
    "目的は、grep可能な原文TXTを作ることです。\n"
    "自然な文章への書き換えや要約は不要です。\n"
    "画像に見える文字を、できるだけそのまま出力してください。\n"
    "読めない文字は [判読不能] としてください。\n"
    "改行や段落は、可能な範囲で維持してください。\n"
    "ファイル名案は不要です。\n"
    "タイトル案は不要です。\n"
    "出力は本文テキストだけにしてください。\n"
    "\n"
    "以下の項目を出力してください。\n"
    "画像内で確認できる場合のみ値を記入し、確認できない場合は空欄にしてください。\n"
    "管理番号:\n"
    "受付番号:\n"
    "相談日:\n"
    "相談者:\n"
